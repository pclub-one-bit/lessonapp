        ...
        <div class="col-sm-6">
            {!! Form::model($lesson, ['url' => 'lessons/'.$lesson->id, 'method' => 'put']) !!}
                ...
                <div class="form-group">
                    ...
                    {!! Form::input('datetime-local', 'lesson_datetime', to_datetime_local($lesson->lesson_datetime), ['class' => 'form-control' . ( $errors->has('lesson_datetime') ? ' is-invalid' : '' ), 'required' => 'required']) !!}
                    @component('components.invalid-feedback')
