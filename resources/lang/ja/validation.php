...
return [
    ...
    'attributes' => [
        'subject' => __('columns.subject'),
        'lesson_datetime' => __('columns.lesson_datetime'),
        'body' => __('columns.body'),
        'evaluation' => __('columns.evaluation'),
        'total_participant' => __('columns.total_participant'),
        'total_revenue' => __('columns.total_revenue'),
        'total_expense' => __('columns.total_expense'),
        'total_budget' => __('columns.total_budget'),
        'id' => __('columns.id'),
        'password' => __('columns.password'),
        'password_confirmation' => __('columns.password_confirmation'),
        'participants.*.name' => __('columns.name'),
        'participants.*.parent_name' => __('columns.parent_name'),
        'revenues.*.item' => __('columns.item'),
        'revenues.*.amount' => __('columns.amount'),
        'expenses.*.item' => __('columns.item'),
        'expenses.*.amount' => __('columns.amount'),
    ],
